<template>
      <vx-card title="Licencia Persona" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Tipo de licencia</vs-th>
                <vs-th sort-key="username">Numero de licencia</vs-th>
                <vs-th sort-key="username">Vigencia</vs-th>
            </template>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].tipoLicencia">
                        {{data[indextr].tipoLicencia}}
                    </vs-td>

                    <vs-td :data="data[indextr].numeroLicencia">
                        {{data[indextr].numeroLicencia}}
                    </vs-td>

                    <vs-td :data="data[indextr].vigencia">
                        {{data[indextr].vigencia}}
                    </vs-td>
...
import formulario from'@/views/catalogo/licenciaP/formulario.vue'
import editar from'@/views/catalogo/licenciaP/editar.vue'
