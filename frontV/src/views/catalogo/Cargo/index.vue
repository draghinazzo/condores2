<template>
      <vx-card title="Cargo" code-toggler id="parentx-demo-5">
...
<script>
import servicio from '@/services/catalogos/cargo'
import formulario from'@/views/catalogo/Cargo/formulario.vue'
import editar from'@/views/catalogo/Cargo/editar.vue'
