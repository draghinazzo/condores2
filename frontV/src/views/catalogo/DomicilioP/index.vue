<template>
      <vx-card title="Domicilio Persona" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Colonia</vs-th>
                <vs-th sort-key="username">Alcaldia</vs-th>
                <vs-th sort-key="username">Municipio</vs-th>
                <vs-th sort-key="username">Entidad Federativa</vs-th>
                <vs-th sort-key="username">Codigo Postal</vs-th>
            </template>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].municipio">
                        {{data[indextr].municipio}}
                    </vs-td>
                    ...
                    <vs-td :data="data[indextr].codigoPostal">
                        {{data[indextr].codigoPostal}}
                    </vs-td>
...
import formulario from'@/views/catalogo/DomicilioP/formulario.vue'
import editar from'@/views/catalogo/DomicilioP/editar.vue'
  ...
  methods: {
    ...
    abrirFormulario(){
     ...
     handleSearch(searching) {
      this.queryPage.colonia = searching
      this.getDatos()
    },
    pagina(){
