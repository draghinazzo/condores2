<template>
      <vx-card title="Persona" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Persona</vs-th>
                <vs-th sort-key="username">Apellido 1</vs-th>
                <vs-th sort-key="username">Apellido 2</vs-th>
                <vs-th sort-key="username">RFC</vs-th>
                <vs-th sort-key="username">CUIP</vs-th>
                <vs-th sort-key="username">CURP</vs-th>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].numeroEmpleado">
                        {{data[indextr].numeroEmpleado}}
                    </vs-td>
                    ...
                    <vs-td :data="data[indextr].apellido1">
                        {{data[indextr].apellido1}}
                    </vs-td>

                    <vs-td :data="data[indextr].apellido2">
                        {{data[indextr].apellido2}}
                    </vs-td>
                    ...
                    <vs-td :data="data[indextr].cuip">
                        {{data[indextr].cuip}}
                    </vs-td>

                    <vs-td :data="data[indextr].curp">
                        {{data[indextr].curp}}
                    </vs-td>
...
import formulario from'@/views/catalogo/Personal/formulario.vue'
import editar from'@/views/catalogo/Personal/editar.vue'
