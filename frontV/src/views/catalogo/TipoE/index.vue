<template>
      <vx-card title="Tipo Empleado" code-toggler id="parentx-demo-5">
...
<script>
import medio from '@/services/catalogos/tipoE'
import formulario from'@/views/catalogo/TipoE/formulario.vue'
import editar from'@/views/catalogo/TipoE/editar.vue'
