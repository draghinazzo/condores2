<template>
      <vx-card title="Solicitante" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Cargo</vs-th>
...
<script>
import servicio from '@/services/catalogos/solicitante'
import formulario from'@/views/catalogo/Solicitante/formulario.vue'
import editar from'@/views/catalogo/Solicitante/editar.vue'
