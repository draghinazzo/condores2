<template>
      <vx-card title="Institucion" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Institucion</vs-th>
...
import formulario from'@/views/catalogo/Institucion/formulario.vue'
import editar from'@/views/catalogo/Institucion/editar.vue'
