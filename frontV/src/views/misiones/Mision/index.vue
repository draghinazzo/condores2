<template>
      <vx-card title="Mision" code-toggler id="parentx-demo-5">
      ...
      <vs-button @click="abrirFormulario" color="primary" type="filled">Agregar nuevo registro</vs-button>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Helicoptero</vs-th>
                <vs-th sort-key="username">Servicio</vs-th>
            </template>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].helicoptero">
                        {{data[indextr].helicoptero}}
                    </vs-td>

                    <vs-td :data="data[indextr].servicio">
                        {{data[indextr].servicio}}
                    </vs-td>
...
// import formulario from'@/views/misiones/Mision/formulario.vue'
// import editar from'@/views/misiones/Mision/editar.vue'
