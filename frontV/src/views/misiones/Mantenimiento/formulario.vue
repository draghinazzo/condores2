...
export default {
  ...
  methods: {
    ...
    submitForm() {
        ...
        console.log('this.form.fechaInicio', this.form.fechaInicio)
        if (this.selechelicoptero === null || this.form.fechaInicio == null) {
          if(this.selechelicoptero === null){
            this.mostrarM = true
          } else {
            this.mostrarM2 = true
          }
