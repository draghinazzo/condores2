<template>
      <vx-card title="Mantenimiento" code-toggler id="parentx-demo-5">
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].placaH">
                        {{data[indextr].placaH}}
                    </vs-td>

                    <vs-td :data="data[indextr].modeloH">
                        {{data[indextr].modeloH}}
                    </vs-td>
...
import formulario from'@/views/misiones/Mantenimiento/formulario.vue'
import editar from'@/views/misiones/Mantenimiento/editar.vue'
