<template>
    <vx-card title="Inicio" code-toggler id="parentx-demo-5">
        <div class="h-screen flex w-full bg-img">
            <div class="vx-col flex items-center justify-center flex-col sm:w-1/2 md:w-3/5 lg:w-3/4 xl:w-1/2 mx-auto text-center">
                ...
                <h1 class="sm:mx-0 mx-4 mb-12 text-5xl d-theme-heading-color">dashBoard</h1>
                <p class="sm:mx-0 mx-4 mb-4 sm:mb-16 d-theme-text-inverse">Principal</p>
            </div>
        </div>
    </vx-card>
</template>