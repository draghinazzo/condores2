      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Marca</vs-th>
                <vs-th sort-key="username">Estatus</vs-th>
            </template>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].placa">
                        {{data[indextr].placa}}
                    </vs-td>

                    <vs-td :data="data[indextr].modelo">
                        {{data[indextr].modelo}}
                    </vs-td>
                    
                    <vs-td :data="data[indextr].marca">
                        {{data[indextr].marca}}
                    </vs-td>
...
import formulario from'@/views/helicopteros/formulario.vue'
import editar from'@/views/helicopteros/editar.vue'
