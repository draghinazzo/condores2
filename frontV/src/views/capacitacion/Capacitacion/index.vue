<template>
      <vx-card title="Capacitacion" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Empleado en curso</vs-th>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].instructorNombre">
                        {{data[indextr].instructor}}
                        {{data[indextr].instructorApellido}}
...
import formulario from'@/views/capacitacion/Capacitacion/formulario.vue'
import editar from'@/views/capacitacion/Capacitacion/editar.vue'
