<template>
      <vx-card title="Instructor" code-toggler id="parentx-demo-5">
      ...
      <editar :id="idE" :ver="activeEditar" @cerrar="ocultarVentanaEditar" ></editar>
        ...
        <vs-table :sst="true" :max-items="10" search @search="handleSearch" :data="medio">
            <template slot="thead">
                ...
                <vs-th sort-key="username">Especialidad</vs-th>
            </template>
            ...
            <template slot-scope="{data}">
                <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="data[indextr].especialidad">
...
import formulario from'@/views/capacitacion/Instructor/formulario.vue'
import editar from'@/views/capacitacion/Instructor/editar.vue'
