    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='users.permisos')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical Modelo permiso',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': 'history_date',
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.AddField(
            model_name='user',
            name='permissions',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.permisos'),
        ),
        migrations.AddField(
            model_name='user',
