...
class persona(BaseModel):
    ...
    capacidad = models.CharField(max_length=255,null=True)
    numeroEmpleado = models.CharField(max_length=255,null=True)
    nombre = models.CharField(max_length=255,null=True)
    apellido1 = models.CharField(max_length=255,null=True)
    apellido2 = models.CharField(max_length=255,null=True)
    ...
    telefono_oficina = models.CharField(max_length=255,null=True)
    extension = models.CharField(max_length=255,null=True)
    telefono_celular = models.CharField(max_length=255,null=True)
    adscripcion_general = models.CharField(max_length=255,null=True)
    ...
    escolaridad = models.CharField(max_length=255,null=True)
    sexo = models.ForeignKey(catSexo, on_delete=models.SET_NULL, null=True)
    edad = models.CharField(max_length=255,null=True)
    antiguedad = models.CharField(max_length=255,null=True)
    
    numeroLicencia = models.CharField(max_length=255,null=True)
    vigencia = models.DateField(null=True)
    tipoLicencia = models.CharField(max_length=255,null=True)
    '''
